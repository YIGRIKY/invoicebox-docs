...
| languageId      | нет          | string                              | Язык интерфейса платежной страницы              | `RU`
...
| returnUrl       | нет          | string                              | Ссылка для перехода на сайт Магазина в иных случаях           |

#### Customer - покупатель

| Свойство            | Обязательное | Тип                | Описание          | Пример значения 
| ------------------- | ------------ | ------------------ | ----------------- | --------------- 
| type                | да           | string             | Тип               | `private`, `public`
...
| registrationAddress | да           | string             | Юр. адресс        | `Невский 147`
