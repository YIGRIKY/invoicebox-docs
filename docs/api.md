...
В запросах необходимо перадавать HTTP-заголовки:
 ...
 | User-Agent   | идентификатор приложения* | Обязательно
 | X-Signature  | подпись запроса           | Обязательно в случае использование механизма подписи запроса


* Идентификатор приложения формируется в следующем формате:

Наименование приложения/версия (версия модулия, если применимо) <иные идентификаторы>
