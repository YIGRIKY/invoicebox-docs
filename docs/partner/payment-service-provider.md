...
1. В случае, если магазин принял запрос, система &laquo;Инвойсбокс&raquo; предоставляет партнёру доступ к магазину для создания в нём заказов и оформления счетов
