...
| parentId               | нет          | string(36)                         | Идентификатор базового заказа, применимо для создания [корректирующих заказов](/docs/refund/correction/)                            | `01771534-196a-1105-839a-82422289d6d9` |
