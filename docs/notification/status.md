...
|`order_wrong_amount`   | Ошибка сверки сумм заказа в учетной системе Магазина и системы &laquo;ИнвойсБокс&raquo;
|`order_already_paid`   | Заказ уже оплачен
|`order_not_found`      | Заказ не найден в учетной системе Магазина
