...
![Подключить](/assets/images/scenarios/pms/frame1.png){: .img-right}
...
![Активировать](/assets/images/scenarios/pms/frame2.png){: .img-left}
...
![Способ оплаты](/assets/images/scenarios/pms/frame3.png){: .img-right}
...
После успешного формирования заказа, система PMS переадресует гостя на страницу системы Инвойсбокс для подтверждения
оплаты заказа.

![Подтверждение оплаты](/assets/images/scenarios/pms/frame4.png){: .img-left}
...
![Маркетплейс](/assets/images/scenarios/pms/frame5.png){: .img}
